...
class PoolLedger {
     ...
     * @param {string} [submitterDid]
     * @param {string} [ledgerType] default POOL
     * @param {number} seqNo
     * @return {Promise<object>} transaction
     */
    async getTxn(submitterDid, ledgerType, seqNo) {
        return this._request(sdk.buildGetTxnRequest, sdk.submitRequest, [submitterDid, ledgerType, seqNo], []);
    }
